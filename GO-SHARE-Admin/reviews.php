...
$sql = "SELECT rw.*, r.* FROM review rw INNER JOIN register r ON rw.log_id = r.log_id
";
              ...
              <div class="sidebar_blog_1">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="availableVouchers.php"><i class="fa fa-user red_color"></i> <span>AVAILABLE VOUCHERS</DETAILS> </span></a></li>
                    
                     
                      <li><a href="complaint1.php"><i class="fa fa-comments-o green_color"></i> <span>COMPLAINTS</span></a></li>
                      <li><a href="reviews.php"><i class="fa fa-star blue_color"></i> <span>REVIEWS</DETAILS> </span></a></li>
                                             ...
                                             ?>
                                                <li>
                                                  ...
                                                  < <span> <div class="couter_icon">
                                                   ...
                                                   <span class="msg_user"><?php echo $row['review']; ?></span>
                                                   <span class="name_user"><?php echo $row['rating']." stars"; ?></span>
                                                   <span class="time_ago"> <?php echo $row['date']; ?></span>
                                                   </span>
                                                </li>
                                                <?php
                                                $counter++;
