                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => offerpool(
                                    starting_point: snapshot.data[index]
                                        ['starting_point'],
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => gm_details_page(
                                  ...
                                  time: snapshot.data[index]['time'],
                                  date: snapshot.data[index]['date'],
                                  vehModel: snapshot.data[index]['vehModel'],
                                  goodsType: snapshot.data[index]['goodsType'],
                                  weight: snapshot.data[index]['weightLeft'],
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => gt_detail(
                                  ...
                                  vehicle_type: snapshot.data[index]
                                      ['vehicle_type'],
                                  group_name: snapshot.data[index]
                                      ['group_name'],
                                ),
                              ),
                            );
