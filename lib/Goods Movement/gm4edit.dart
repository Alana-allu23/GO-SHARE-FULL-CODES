...
class gm4edit extends StatefulWidget {
  gm4edit({
    Key? key,
  ...
  var starting_point,
      ...
      vehModel;
  @override
  State<gm4edit> createState() => _gm4editState();
}

class _gm4editState extends State<gm4edit> {
  var pick;
  var time_pick;
  ...
  var gmctrl = TextEditingController();
  ...
  final goodskey = GlobalKey<FormState>();
  ...
  Future<void> senddata() async {
    ...
    var response = await post(Uri.parse("${con.url}goods_movement/update.php"),
        body: data);
    print(response.body);
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (goodskey.currentState!.validate()) {
                            senddata();
                          }
                        },
                        child: Text(
