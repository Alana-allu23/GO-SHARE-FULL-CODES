...
class _gt5State extends State<gt5> {
  ...
  Future<void> senddata() async {
    ...
    var response =
        await post(Uri.parse("${con.url}group_trip/update.php"), body: data);
    print(response.body);
    if (response.statusCode == 200) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Group trip Updated')));
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => gt4()),
