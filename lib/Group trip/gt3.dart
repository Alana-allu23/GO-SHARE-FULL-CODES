...
class _gt3State extends State<gt3> {
  ...
  Future<void> senddata() async {
    ...
    print('***************INSIDE INSERT FN*********************');
    print(data);
    var response =
        await post(Uri.parse("${con.url}group_trip/insert.php"), body: data);
    print(response.body);
    if (response.statusCode == 200) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Group trip created')));
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => gt2()),
